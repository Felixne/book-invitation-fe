...
const OrderDeliveryForm = () => {
  ...
  return (
    <div className="xs:col-span-5 xs:text-sm md:text-base lg:col-span-2 h-fit xs:p-2 md:p-6 border-gray-100 xs:border-none md:border-2 rounded-xl flex flex-wrap xs:gap-2 md:gap-6">
