...
const Info = () => {
  ...
  return (
    <div className="w-12 h-12 z-50 fixed  border-2 border-gray-100 bg-primary-200 text-slate-700 xs:bottom-1/4 xs:right-4 md:bottom-6 md:right-6 rounded-full shadow-md">
